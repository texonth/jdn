...
import {CaretRightOutlined, DeleteOutlined, UserOutlined} from '@ant-design/icons';
    ...
    return (
      <div>
        <div onClick={this.handleShowList}>
          ...
          <CaretRightOutlined rotate={this.show ? 0 : 90} onClick={this.handleAddRule} />
