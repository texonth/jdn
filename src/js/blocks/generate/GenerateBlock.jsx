      ...
      <div>
        <div>
          <div className={`${classes.generateStyle} BtnGroup`}>
            <Button size={"small"} onClick={this.handleGenerate}>
              Generate
            </Button>
            <Button size={"small"} onClick={this.handleOpenSettings}></Button>
          </div>
        </div>
        <div>
          ...
          <div className={`${classes.generateStyleAll}`}>
            ...
            <Button size={"small"} onClick={this.handleExportUrlsListJSON}>
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="16"
                height="16"
