...
class App extends React.Component {
  ...
  render() {
    ...
    const ComponentLeft = this.mainModel.ApplicationMap.get(
      this.mainModel.currentTab
    ).componentsLeft[currentLeftPart];
    const currentRightPart = this.mainModel.currentRightPart;
    const ComponentRight = this.mainModel.ApplicationMap.get(
      this.mainModel.currentTab
    ).componentsRight[currentRightPart];
